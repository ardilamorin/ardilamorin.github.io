...
### Roles: Patient for one illness /caretaker for anotherWe found that some of the users were patients for an illness, but also had a family member with another illness, and the way the wanted to interact with the platform was different  depending on the the role they were playing.
